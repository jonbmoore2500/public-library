    ...
    return(
        <div>
            ...
            <div className="chapter-content help-page">
                <h3>Background</h3>
                <p><strong>Public Library</strong> is an app that allows Users to curate a selection of books they may be interested in lending to other people and to peruse the selections that other Users have made available. Users can then arrange Exchanges, organizing those Exchanges through a specific interface and a Messaging functionality.</p>
                <h3>Profile</h3>
                ...
                <h3>Your Library</h3>
                <p>Curate your book selection here. You can add new books to your list, delete books that you no longer own or wish to lend out, and edit existing books, including hiding them temporarily or checking them back in if you received them outside the normal Exchange process.</p>
                <h3>Exchanges</h3>
                ...
                <p>Explore the profiles of other Users here. See who they are and what books they have. You can request to borrow one of their books here, or send them messages about a book they have available.</p>
